...
(defsection it-finally-works
  ...
  ((image-figure
    ...
    :width 652
    :height 359
    :alt "A Windows 98 console window displaying a truncated list of Universal Chess Interface options supported by Stockfish and the information about the used compiler, GCC 10.2.1 20200924, as responses to the \"uci\" and \"compiler\" UCI commands respectively.")
